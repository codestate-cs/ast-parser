...
describe('BaseStorage', () => {
  ...
  describe('updateMetadata', () => {
    ...
    it('should update metadata with custom config', async () => {
      ...
      const result = await mockStorage.updateMetadata(
        mockVersionInfo.id,
        newMetadata,
        customConfig
      );
  ...
  describe('additional BaseStorage methods', () => {
    ...
    describe('createStorageMetadata', () => {
      ...
      it('should create storage metadata with additional metadata', () => {
        ...
        const metadata = (mockStorage as any).createStorageMetadata(
          mockVersionInfo,
          additionalMetadata
        );
    ...
    describe('importData', () => {
      ...
      it('should reject import data without versions', async () => {
        ...
        await expect(mockStorage.importData(invalidData)).rejects.toThrow(
