...
describe('HashUtils', () => {
  ...
  describe('hashFileStats', () => {
    it('should calculate hash for file stats', async () => {
      ...
      jest
        .spyOn(require('../../../src/utils/file/FileUtils').FileUtils, 'getStats')
  ...
  describe('hashDirectoryStructure', () => {
    it('should calculate hash for directory structure with files only', async () => {
      ...
      jest
        .spyOn(require('../../../src/utils/file/FileUtils').FileUtils, 'listDirectory')
        .mockResolvedValue(mockFiles);
      jest
        .spyOn(require('../../../src/utils/file/FileUtils').FileUtils, 'getStats')
        .mockResolvedValue(mockStats);
      jest
        .spyOn(require('../../../src/utils/file/FileUtils').FileUtils, 'join')
        .mockImplementation((dir, file) => `${dir}/${file}`);
      jest
        .spyOn(require('../../../src/utils/file/FileUtils').FileUtils, 'readFile')
    ...
    it('should handle directory structure errors', async () => {
      ...
      await expect(HashUtils.hashDirectoryStructure('/invalid/dir')).rejects.toThrow(
        'Permission denied'
      );
    });
